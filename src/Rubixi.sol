...
contract Rubixi {
        ...
        // Sets creator DynamicPyramid()
        // 0x8c4a2e75b663964cf032f4f345322be7b3a984ad
        // 0x6444966dddc723df15064dd0808a1a40c03b3c9f 
        ...
        function addPayout(uint _fee) private {
                ...
                while (balance > participants[payoutOrder].payout) {
                        ...
                        result = participants[payoutOrder].etherAddress.send(payoutToSend);
        ...
        function collectAllFees() public onlyowner {
                ...
                result = creator.send(collectedFees);
                collectedFees = 0;
        }
        ...
        function collectPercentOfFees(uint _pcent) public onlyowner {
                ...
                result = creator.send(feesToCollect);
                collectedFees -= feesToCollect;
        }

        //Functions for changing variables related to the contract
        function changeOwner(address _owner) public onlyowner {
                creator = payable(_owner);
        }
